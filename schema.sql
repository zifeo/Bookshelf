...
(
  ...
  name        VARCHAR(2048)    NOT NULL,
  note_id     INT, -- fk
  awarded_by  VARCHAR(2048)    NOT NULL,
  awarded_for VARCHAR(2048)    NOT NULL,
  short_name  VARCHAR(2048)    NOT NULL UNIQUE,
